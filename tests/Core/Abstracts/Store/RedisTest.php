...
class RedisTest extends TestCase
{
    ...
    public function testEncryptContext()
    {
        ...
        $mockInterface = $this->createMock(Client::class);
        $redisStore = new MockAbstractRedisStore($mockInterface);
        $redisStore->setNamespace(CommonConstants::NAMESPACE_CONTENTS);
        $encryptedContext = $redisStore->encryptContext($context, 'secret@password');
    ...
    public function testDecryptContext()
    {
        ...
        $redisStore = new MockAbstractRedisStore($mockInterface);
        $redisStore->setNamespace(CommonConstants::NAMESPACE_CONTENTS);
        $decryptedContext = $redisStore->decryptContext($context, 'secret@password');
